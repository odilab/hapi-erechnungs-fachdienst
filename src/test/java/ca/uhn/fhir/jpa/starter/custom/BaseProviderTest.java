...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {
    ...
    "hapi.fhir.custom-provider-classes=ca.uhn.fhir.jpa.starter.custom.operation.submit.SubmitOperationProvider,ca.uhn.fhir.jpa.starter.custom.operation.retrieve.RetrieveOperationProvider,ca.uhn.fhir.jpa.starter.custom.operation.processFlag.ProcessFlagOperationProvider",
